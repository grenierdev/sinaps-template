...
TemplateSourceElements
  = elements:TemplateSourceElement* {
      return elements;
    }
...
TemplateBlock
  = __ "extends" __ template:StringLiteral __ {
      return {
        type: "TemplateExtend",
        template: template,
        location: location()
  ...
  / __ "import" __ template:StringLiteral __ "as" __ as:Identifier __ {
      return {
        location: location(),
        type: "TemplateImport",
        template: template,
  ...
  / __ "set" __ expression:AssignmentExpression __ {
      return {
        type: "TemplateSet",
        expression: expression,
        location: location()
  ...
  / __ "raw" __ "%}" raw:(!("{%" __ "endraw" __ "%}") SourceCharacter)* "{%" __ "endraw" __ {
      return {
        type: "TemplateRaw",
  ...
  / __ "macro" __ name:Identifier args:(Arguments)? __ {
      return {
        type: "TemplateMacro",
        name: name,
        arguments: args,
  ...
  / __ "endmacro" __ { return { type: "TemplateEndMacro", location: location() } }
  / __ "block" __ name:Identifier __ {
      return {
        type: "TemplateBlock",
        name: name,
        location: location()
  ...
  / __ "endblock" __ { return { type: "TemplateEndBlock", location: location() } }
  / __ "for" __ key:(Identifier __ "," __)? value:Identifier __ "in" __ list:Expression __ {
      return {
        type: "TemplateFor",
        key: key,
        value: value,
  ...
  / __ "endfor" __ { return { type: "TemplateEndFor", location: location() } }
  / __ "if" __ test:Expression __ {
      return {
        type: "TemplateIf",
        test: test,
        location: location()
  ...
  / __ "else" __ "if" __ test:Expression __ {
      return {
        type: "TemplateElseIf",
        test: test,
        location: location()
  ...
  / __ "endif" __ { return { type: "TemplateEndIf", location: location() } }
