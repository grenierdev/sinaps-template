...
module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c150 = function(elision) {
              return {
                type:     "ArrayExpression",
                elements: optionalList(extractOptional(elision, 0))
              };
            },
        peg$c151 = function(elements) {
              return {
                type:     "ArrayExpression",
                elements: elements
              };
        ...
        peg$c154 = function(elements, elision) {
              return {
                type:     "ArrayExpression",
                elements: elements.concat(optionalList(extractOptional(elision, 0)))
              };
            },
        peg$c155 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c156 = function(head, elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c157 = function(head, tail) { return Array.prototype.concat.apply(head, tail); },
        peg$c158 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c159 = "{",
        peg$c160 = { type: "literal", value: "{", description: "\"{\"" },
        peg$c161 = function() { return { type: "ObjectExpression", properties: [] }; },
        peg$c162 = function(properties) {
        ...
        peg$c167 = function(id) { return [id]; },
        peg$c168 = function(head, property) {
                  return { property: property, computed: true };
                },
        peg$c169 = function(head, property) {
        ...
        peg$c181 = function(operator, argument) {
        ...
        peg$c243 = function(test, consequent, alternate) {
              return {
        ...
        peg$c245 = function(left, operator, right) {
              return {
                type:     "AssignmentExpression",
                operator: operator,
                left:     left,
        ...
        peg$c269 = function(head, tail) { return buildList(head, tail, 1); },
        ...
        peg$c277 = function(comment) { return { type: 'TemplateComment', value: comment }; },
        peg$c278 = "{{",
        peg$c279 = { type: "literal", value: "{{", description: "\"{{\"" },
        peg$c280 = "}}",
        peg$c281 = { type: "literal", value: "}}", description: "\"}}\"" },
        peg$c282 = function(literal) { return { type: 'TemplateLiteral', value: literal }; },
        peg$c283 = "{%",
        ...
        peg$c290 = "set",
        peg$c291 = { type: "literal", value: "set", description: "\"set\"" },
        ...
        peg$c293 = "macro",
        peg$c294 = { type: "literal", value: "macro", description: "\"macro\"" },
        peg$c295 = "endmacro",
        peg$c296 = { type: "literal", value: "endmacro", description: "\"endmacro\"" },
        peg$c297 = function(name, body) {
              return {
                type: "TemplateMacro",
                name: name,
        ...
        peg$c298 = "block",
        peg$c299 = { type: "literal", value: "block", description: "\"block\"" },
        peg$c300 = "endblock",
        peg$c301 = { type: "literal", value: "endblock", description: "\"endblock\"" },
        peg$c302 = function(name, body) {
              return {
                type: "TemplateBlock",
                name: name,
                body: optionalList(extractOptional(body, 0))
        ...
        peg$c303 = "for",
        peg$c304 = { type: "literal", value: "for", description: "\"for\"" },
        peg$c305 = "in",
        peg$c306 = { type: "literal", value: "in", description: "\"in\"" },
        peg$c307 = "endfor",
        peg$c308 = { type: "literal", value: "endfor", description: "\"endfor\"" },
        peg$c309 = function(key, value, list, body) {
              return {
                type: "TemplateFor",
                key: key,
                value: value,
        ...
        peg$c310 = "endif",
        peg$c311 = { type: "literal", value: "endif", description: "\"endif\"" },
        peg$c312 = function(condition) {
              return condition;
            },
        peg$c313 = "if",
        peg$c314 = { type: "literal", value: "if", description: "\"if\"" },
        peg$c315 = "else",
        peg$c316 = { type: "literal", value: "else", description: "\"else\"" },
        peg$c317 = function(test, consequent, alternate) {
              return {
                type: "TemplateIfElse",
                test: test,
                consequent: optionalList(extractOptional(consequent, 0)),
                alternate: alternate
              }
            },
        peg$c318 = function(test, consequent) {
              return {
                type: "TemplateIf",
                test: test,
                consequent: optionalList(extractOptional(consequent, 0))
        ...
        peg$c319 = function(alternate) {
              return {
                type: "TemplateElse",
                alternate: optionalList(extractOptional(alternate, 0))
              }
            },
    ...
    function peg$parseNonSourceElement() {
      var s0, s1, s2;
    ...
    function peg$parseSourceElement() {
      ...
      if (s0 === peg$FAILED) {
        s0 = peg$currPos;
        s1 = peg$parseNonSourceElement();
        if (s1 !== peg$FAILED) {
          s2 = [];
          s3 = peg$parseNonSourceElement();
          while (s3 !== peg$FAILED) {
            s2.push(s3);
            s3 = peg$parseNonSourceElement();
          }
                      ...
                      if (s9 !== peg$FAILED) {
                        ...
                        if (s10 !== peg$FAILED) {
                          ...
                          if (s11 !== peg$FAILED) {
                            s12 = peg$parse__();
                            if (s12 !== peg$FAILED) {
                              s13 = peg$parseIfStatement();
                              if (s13 !== peg$FAILED) {
                                peg$savedPos = s0;
                                s1 = peg$c317(s3, s7, s13);
                                s0 = s1;
                              } else {
                                peg$currPos = s0;
                                s0 = peg$FAILED;
