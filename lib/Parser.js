...
module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c391 = function(comment) {
              return {
                type: 'TemplateComment',
                //value: extractList(comment, 1).join(''),
                //location: location()
              };
            },
        peg$c392 = "{{",
        ...
        peg$c399 = "raw",
        peg$c400 = { type: "literal", value: "raw", description: "\"raw\"" },
        peg$c401 = "%}",
        peg$c402 = { type: "literal", value: "%}", description: "\"%}\"" },
        peg$c403 = "endraw",
        peg$c404 = { type: "literal", value: "endraw", description: "\"endraw\"" },
        peg$c405 = function(raw) {
              return text();
            },
        peg$c406 = function(template) {
              return {
                location: location(),
                type: "TemplateExtend",
                template: template,
        ...
        peg$c408 = "endmacro",
        peg$c409 = { type: "literal", value: "endmacro", description: "\"endmacro\"" },
        peg$c410 = function() { return { type: "TemplateEndMacro" } },
        peg$c411 = "macro",
        peg$c412 = { type: "literal", value: "macro", description: "\"macro\"" },
        peg$c413 = function(name, body) {
              return {
                type: "TemplateMacro",
                name: name,
                body: body,
        ...
        peg$c414 = "endblock",
        peg$c415 = { type: "literal", value: "endblock", description: "\"endblock\"" },
        peg$c416 = function() { return { type: "TemplateEndBlock" } },
        peg$c417 = "block",
        peg$c418 = { type: "literal", value: "block", description: "\"block\"" },
        peg$c419 = function(name, body) {
              return {
                type: "TemplateBlock",
                name: name,
                body: body,
        ...
        peg$c420 = "endfor",
        peg$c421 = { type: "literal", value: "endfor", description: "\"endfor\"" },
        peg$c422 = function() { return { type: "TemplateEndFor" } },
        peg$c423 = function(key, value, list, body) {
              return {
                type: "TemplateFor",
                key: key,
                value: value,
        ...
        peg$c424 = "endif",
        peg$c425 = { type: "literal", value: "endif", description: "\"endif\"" },
        peg$c426 = function() { return { type: "TemplateEndIf" } },
        ...
        peg$c428 = "elseif",
        peg$c429 = { type: "literal", value: "elseif", description: "\"elseif\"" },
        peg$c430 = function(test, consequent) {
              return {
                type: "TemplateElseIf",
                test: test,
                consequent: consequent,
    ...
    function peg$parseProgram() {
      ...
      s0 = peg$currPos;
      s1 = peg$parseTemplateSourceElements();
      if (s1 === peg$FAILED) {
        s1 = null;
      }
      if (s1 !== peg$FAILED) {
    ...
    function peg$parseTemplateSourceElements() {
      var s0, s1, s2;

      s0 = peg$currPos;
      s1 = [];
      s2 = peg$parseTemplateSourceElement();
      while (s2 !== peg$FAILED) {
        s1.push(s2);
        s2 = peg$parseTemplateSourceElement();
      }
    ...
    function peg$parseTemplateSourceElement() {
      var s0, s1, s2, s3;

      s0 = peg$parseTemplateStatement();
      if (s0 === peg$FAILED) {
        s0 = peg$currPos;
    ...
    function peg$parseTemplateStatementList() {
      var s0, s1, s2, s3, s4, s5;

      s0 = peg$currPos;
      s1 = peg$parseTemplateStatement();
      if (s1 !== peg$FAILED) {
        s2 = [];
        s3 = peg$currPos;
        s4 = peg$parse__();
        if (s4 !== peg$FAILED) {
          s5 = peg$parseTemplateStatement();
          if (s5 !== peg$FAILED) {
            s4 = [s4, s5];
            s3 = s4;
          } else {
    ...
    function peg$parseTemplateStatement() {
      var s0, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15;
                        ...
                        if (s4 !== peg$FAILED) {
                          ...
                          if (s5 !== peg$FAILED) {
                            ...
                            if (s6 !== peg$FAILED) {
                              ...
                              if (s7 !== peg$FAILED) {
                                s8 = peg$parseTemplateSourceElements();
                                if (s8 !== peg$FAILED) {
                                  peg$savedPos = s0;
                                  s1 = peg$c413(s5, s8);
                                  s0 = s1;
                                          ...
                                          if (s9 !== peg$FAILED) {
                                            ...
                                            if (s10 !== peg$FAILED) {
                                              ...
                                              if (s11 !== peg$FAILED) {
                                                ...
                                                if (s12 !== peg$FAILED) {
                                                  s13 = peg$parseTemplateSourceElements();
                                                  if (s13 !== peg$FAILED) {
                                                    peg$savedPos = s0;
                                                    s1 = peg$c423(s5, s6, s10, s13);
                                                    s0 = s1;
                                                  } else {
                                                    peg$currPos = s0;
                                                    s0 = peg$FAILED;
                                    ...
                                    if (s2 !== peg$FAILED) {
                                      ...
                                      if (s3 !== peg$FAILED) {
                                        ...
                                        if (s4 !== peg$FAILED) {
                                          ...
                                          if (s5 !== peg$FAILED) {
                                            s6 = peg$parseTemplateSourceElements();
                                            if (s6 !== peg$FAILED) {
                                              peg$savedPos = s0;
                                              s1 = peg$c431(s6);
                                              s0 = s1;
